...
export default function Home() {
  ...
  if(darkstate === true){
    document.getElementsByClassName('main').style.background = "linear-gradient(180deg, #5177FF 0%, #55C2FF 100%)"
  }
  const HandleSwitch = () => {
    setDark(true)
  }
  ...
  return (
    <div className="main" background={darkstate ? "linear-gradient(180deg, #5177FF 0%, #55C2FF 100%)" : "linear-gradient(180deg, #FF85DD 0%, #FFA4E5 100%)"}>
