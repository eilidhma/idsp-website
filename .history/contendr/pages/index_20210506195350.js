...
export default function Home() {
  ...
  return (
    <div id="m" className="main" background={darkstate === true ? "linear-gradient(180deg, #5177FF 0%, #55C2FF 100%)" : "linear-gradient(180deg, #FF85DD 0%, #FFA4E5 100%)"}>
      <div className="content">
        <Logo />
        <Switch 
        backgroundColor={darkstate === true ? "FFA4E5" : "#5177FF"}
