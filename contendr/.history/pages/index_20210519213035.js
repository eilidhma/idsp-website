      ...
      <div className="content">
        ...
        <div className="row" style={{flexDirection: 'column'}} data-aos="fade-up">
          ...
          <div style={{ height: '50vh', margin: '5vh 0 0 0 ', display: 'grid', gridTemplateColumns: 'auto auto auto', gridTemplateRows: 'auto auto', justifyContent: 'space-between'}}>
            ...
            <Profile name="Jojo L." role="Designer" src="/jojo.JPG"/>
            <Profile name="Octavio V." role="Developer" src="/octavio.jpg" />
            <Profile name="Sarah W." role="Developer" src="/octavio.jpg" />
            <Profile name="Eilidh M.A." role="Developer" src="/jojo.JPG"/>
            <Profile name="Julian M." role="Developer" src="/octavio.jpg" />
            <Profile name="Jesse W." role="Developer" src="/octavio.jpg" />
