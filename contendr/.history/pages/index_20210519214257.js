    ...
    >
      <div className="content">
        ...
        <div className="row" style={{flexDirection: 'column'}} data-aos="fade-up">
            ...
            <h1>The Team</h1>
            <p>
              Contendr was designed and developed by six BCIT students in an interdisciplinary team. Eilidh, Julian, and Jesse were the design masterminds behind the concept, and passed off their work to Jojo, Octavio, and Sarah to perform their 
            </p>
