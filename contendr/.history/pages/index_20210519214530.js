    ...
    >
      <div className="content">
        ...
        <div className="row" style={{flexDirection: 'column'}} data-aos="fade-up">
            ...
            <h1>The Team</h1>
            <p>
              Contendr was designed and developed by six BCIT students in an interdisciplinary team. Eilidh, Julian, and Jesse are students in the Digital Design and Development program, and  behind the concept. and passed off their work to the talented developers, Jojo, Octavio, and Sarah and bring the app to life. 
            </p>
