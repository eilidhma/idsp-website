      ...
      <div className="content">
        ...
        <div className="row" data-aos="fade-up">
          <div className="left">
            ...
            <p>
              Welcome to the future of social media.<br></br>Contendr is a new, fresh, and innovative platform for challenging your friends! With six categories to choose from, Contendr offers the chance to awaken the competitive spirit in everyone. 
            </p>
          </div>
          <div className="right">
