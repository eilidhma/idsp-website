      ...
      <div className="content">
        ...
        <div className="row" data-aos="fade-up">
          <div className="left">
            ...
            <p>
              Welcome to the future of social media.<br></br>Contendr is a new, fresh, and innovative platform for challenging your friends! With six categories to choose from, Contendr offers the chance to awaken the competitive spirit in everyone. <br></br>Challenge your friends to a dance off, bake off
            </p>
          </div>
          <div className="right">
        ...
        <div className="row reverse" data-aos="fade-up">
          ...
          <div className="right">
            <h1>Record Video!</h1>
            <p>
              With Contendr, users have the opportunity to upload video footage from their mobile, tablet, or desktop device and choose a user to challenge. To keep things interesting, Contendr 
            </p>
          </div>
          <PathOne
            scrollPosition={scrollPosition}
