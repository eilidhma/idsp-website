      ...
      <div className="content">
        ...
        <div className="row reverse" data-aos="fade-up">
          ...
          <div className="right">
            <h1>Record Video!</h1>
            <p>
              With Contendr, users have the opportunity to upload video footage from their mobile, tablet, or desktop device and choose a user to challenge. To keep things interesting, six categories are currently available to compete in: Dance, Art, 
            </p>
          </div>
          <PathOne
            scrollPosition={scrollPosition}
