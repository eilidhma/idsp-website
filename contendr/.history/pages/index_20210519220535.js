      ...
      <div className="content">
        ...
        <div className="row" data-aos="fade-up">
          <div className="left">
            ...
            <p>
              Contendr offers a new social media experience. Instead of passively scrolling through feeds and liking content, users have the opportunity to fully engage in the Contendr experience. By participating in challenges yourself, or voting for your favorite contender in your challenge feed, the experience is engaging and fun. 
            </p>
          </div>
          <div className="right">
